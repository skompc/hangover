...
./configure --host=arm-linux-androideabi --prefix=$DESTDIR/build.android/wine-host/dlls/wineandroid.drv/assets/armeabi-v7a CXX=arm-linux-androideai-clang++ CC=arm-linux-androideabi-clang
...
../../glib/configure --with-pcre=internal --host=arm-linux-androideabi CXX=am-linux-androideabi-clang++ CC=arm-linux-androideabi-clang --disable-libmount --prefix=$DESTDIR/build.android/wine-host/dlls/wineandroid.drv/assets/armeabi-v7a
